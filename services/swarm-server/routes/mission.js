...
function createMissionFromPlan(opts = {}) {
  ...
  const mission = {
    ...
    requestedModels: {
      ...
      codingFallback: (models && models.codingFallback) || (/^(1|true|yes|on)$/i.test(String(process.env.SWARM_DISABLE_GLM || '')) ? 'gpt-5.5' : (process.env.SWARM_DEFAULT_GLM_MODEL || 'glm-4.5')),
